 ...
 *  removed unneeded __delay_cycles, created serial interface definitions.
 **************************************************************************************************/
...
void dacWriteWord(unsigned int dacWord, unsigned int dacCtrl){
	...
	while(rxFlag<2);						// waiting until both bytes are sent over SPI to DAC. Effectively polling..
